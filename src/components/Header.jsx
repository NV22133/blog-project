    ...
    <li className="relative group">
      {item.type === "link" ? (
        ...
        <div className='flex flex-col items-center'>
          <button className="px-4 py-2 flex gap-x-1 items-center onClick={toggleDropHandler}">
            <span>{item.name}</span>
            <MdKeyboardArrowDown />
          </button>
          <div className={'{dropdown ? "block" : "hidden"} lg:hidden transition-all duration-500 pt-4 lg:absolute bottom-0 right-0 transform translate-y-full group-hover:block w-max'}>
